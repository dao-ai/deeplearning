...
export const documentationNav = {
  ...
  表: [pages["border-collapse"], pages["border-spacing"], pages["table-layout"], pages["caption-side"]],
  过渡和动画: [
  ...
  转换: [pages["scale"], pages["rotate"], pages["translate"], pages["skew"], pages["transform-origin"]],
  交互性: [
    pages["accent-color"],
    pages["appearance"],
    pages["cursor"],
